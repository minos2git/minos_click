...
//#define MAX_N_ENTRY  16777216 			//2^24 bits: 8 aw, 8 cid1, 8 cid2
//i.e., MAX_N_ENTRY/8 = 16777216/8 = 2097152 bytes .
	static bool r_check_RAT(Packet *p) ;
	static  unsigned char RAT[2097152 ]; //2^24 bits: 8 aw, 8 cid1, 8 cid2 //realized by init_rat shells
	static  int CWs[];
	static  int global_cid;
	static  int global_router_id;
	int     local_router_id;
	static  Vector <String> comp_names;

	//mutable	unsigned long    malicious_comp_id;

	static HashTable<int, int>comp_repeat;  //<cid, repeat times>
	static HashTable<int, int> init_repeat_map();  //realized by init_rat shells

	//static char log_cache[200][WAID_MAX_LEN ];
	//static int log_end_i;
