...
#define HAVE_LINUX_ATOMIC_ADD_RETURN 1
...
#define HAVE_LINUX_ATOMIC_CMPXCHG 1
...
#define HAVE_LINUX_D_MAKE_ROOT 1

/* Define if 'struct dentry' has a 'd_child' member. */
#define HAVE_LINUX_DENTRY_D_CHILD 1
...
#define HAVE_LINUX_SKB_SHINFO_TX_FLAGS_SKBTX_DEV_ZEROCOPY 1
...
#define HAVE_LINUX_SUPER_BLOCK_S_D_OP 1
...
#define HAVE_LINUX_NETDEV_RX_HANDLER_REGISTER 1
